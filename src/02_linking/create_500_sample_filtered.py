"""
Create 500-Match Sample for MANUAL Validation - Filtered Dataset
Different seed from previous samples (seed=2024)
"""
import polars as pl
...
OUTPUT_FILE = PROJECT_ROOT / "data/processed/linking/validation_sample_500_filtered.csv"
...
# Sample with seed=2024 (different from 999 and 42)
df_sample = df_sample.sample(n=500, seed=2024)
...
print(f"Random seed: 2024 (different from previous samples)")
